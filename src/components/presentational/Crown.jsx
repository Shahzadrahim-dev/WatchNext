function Crown({ className, fill, height, width }) {
  return (
    <svg
      className={`${className} group-hover:[fill:#DB1819]
        group-hover:[stroke:#DB1819] transition-[fill,stroke]
        duration-200`}
      fill={fill}
      height={`${height}`}
      width={`${width}`}
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <g>
            {" "}
            <path d="M397.234,357.41h-6.338c-5.632,0-10.199,4.566-10.199,10.199c0,5.633,4.566,10.199,10.199,10.199h6.338 c5.632,0,10.199-4.566,10.199-10.199C407.434,361.976,402.866,357.41,397.234,357.41z"></path>{" "}
          </g>{" "}
        </g>{" "}
      </g>
    </svg>
