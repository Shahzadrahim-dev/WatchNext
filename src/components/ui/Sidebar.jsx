...
function SidebarTrigger({ className, onClick, ...props }) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <BubbleHamburger className="absolute" />
...
function SidebarRail({ className, ...props }) {
  ...
  return (
    <button
      ...
      className={cn(
        `hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden
        w-4 -translate-x-1/2 transition-all ease-linear
        group-data-[side=left]:-right-4
        group-data-[side=right]:left-0 after:absolute
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        `text-sidebar-foreground/70 ring-sidebar-ring flex h-8
        shrink-0 items-center rounded-md px-2 text-xs font-medium
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        justify-center rounded-md p-0 outline-hidden
        transition-transform focus-visible:ring-2 [&>svg]:size-4
        [&>svg]:shrink-0`,
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        [&>svg]:text-sidebar-accent-foreground flex h-7 min-w-0
        -translate-x-px items-center gap-2 overflow-hidden
        rounded-md px-2 outline-hidden focus-visible:ring-2
